...
GType e_cal_config_eee_get_type (void);
...
static void
cal_config_eee_context_free (Context *context)
{
...
static gchar *
cal_config_eee_get_server (ESource *scratch_source)
{
...
static void
cal_config_eee_server_changed_cb (GtkEntry *entry,
                                     Context *context)
{
	ESourceAuthentication *authentication_extension;
	ESourceSecurity *security_extension;
...
static void
cal_config_eee_run_dialog (GtkButton *button,
                              Context *context)
{
	...
	widget = e_eee_chooser_new (
		registry, context->scratch_source, source_type);

	dialog = e_eee_chooser_dialog_new (
		E_EEE_CHOOSER (widget), parent);
...
/*
	...
	g_signal_connect (
		widget, "changed",
		G_CALLBACK (cal_config_eee_server_changed_cb), context);

	text = cal_config_eee_get_server (scratch_source);
	if (text != NULL) {
	...
	g_signal_connect (
		widget, "clicked",
		G_CALLBACK (cal_config_eee_run_dialog), context);
...
static void
e_cal_config_eee_class_init (ESourceConfigBackendClass *class)
{
...
static void
e_cal_config_eee_class_finalize (ESourceConfigBackendClass *class)
{
}

static void
e_cal_config_eee_init (ESourceConfigBackend *backend)
{
}
