...
static void e_cal_backend_3e_factory_instance_init(ECalBackend3eFactory * factory)
{
}

static const char *_get_protocol(ECalBackendFactory * factory)
{
    return "eee";
}

static ECalBackend *_todos_new_backend(ECalBackendFactory * factory, ESource * source)
{
    return g_object_new(e_cal_backend_3e_get_type(), "source", source, "kind", ICAL_VTODO_COMPONENT, NULL);
}

static icalcomponent_kind _todos_get_kind(ECalBackendFactory * factory)
{
    return ICAL_VTODO_COMPONENT;
}

static ECalBackend *_events_new_backend(ECalBackendFactory * factory, ESource * source)
{
    return g_object_new(e_cal_backend_3e_get_type(), "source", source, "kind", ICAL_VEVENT_COMPONENT, NULL);
}

static icalcomponent_kind _events_get_kind(ECalBackendFactory * factory)
{
    return ICAL_VEVENT_COMPONENT;
}

static void _todos_backend_factory_class_init(ECalBackend3eFactoryClass * klass)
{
...
static void _events_backend_factory_class_init(ECalBackend3eFactoryClass * klass)
{
    E_CAL_BACKEND_FACTORY_CLASS(klass)->get_protocol = _get_protocol;
...
static GType events_backend_factory_get_type(GTypeModule * module)
{
    GType type;
    ...
    type = g_type_module_register_type(module, E_TYPE_CAL_BACKEND_FACTORY, "ECalBackend3eEventsFactory", &info, 0);

    return type;
}

static GType todos_backend_factory_get_type(GTypeModule * module)
{
    GType type;
    ...
    type = g_type_module_register_type(module, E_TYPE_CAL_BACKEND_FACTORY, "ECalBackend3eTodosFactory", &info, 0);
